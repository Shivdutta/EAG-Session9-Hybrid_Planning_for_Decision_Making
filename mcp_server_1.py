...
# ------------------- Tools -------------------
@tool()
def log_value(input: LogInput) -> LogOutput:
    """Compute logarithm of a number. Usage: input={"input": {"value": 10, "base": 10}} result = await mcp.call_tool('log_value', input)"""
    print("CALLED: log_value(LogInput) -> LogOutput")
    return LogOutput(result=math.log(input.value, input.base))
